// 退避と追記欄の併用候補 (stash-overflow) — verified
// 現在の時間帯の入力と配置関連状態（配置不可設定を含む）をリセットします。
// 反対側の時間帯と品目マスタは変更しません。
// 専用オリジンまたは不要な入力の時間帯で実行してください。
(() => {
  const rows = [{"type":"充填品","name":"部品C","lot":"L-103","snp":10,"qty":245},{"type":"充填品","name":"部品A","lot":"L-101","snp":10,"qty":120},{"type":"充填品","name":"部品B","lot":"L-102","snp":10,"qty":70},{"type":"充填品","name":"部品D","lot":"L-104","snp":10,"qty":140},{"type":"充填品","name":"部品E","lot":"L-105","snp":10,"qty":60},{"type":"製品","name":"製品X","lot":"P-201","snp":10,"qty":60},{"type":"製品","name":"製品Y","lot":"P-202","snp":10,"qty":90},{"type":"製品","name":"製品Z","lot":"P-203","snp":10,"qty":110},{"type":"製品","name":"製品W","lot":"P-204","snp":10,"qty":80},{"type":"充填品","name":"部品1","lot":"L-201","snp":10,"qty":10},{"type":"充填品","name":"部品2","lot":"L-202","snp":10,"qty":10},{"type":"充填品","name":"部品3","lot":"L-203","snp":10,"qty":10},{"type":"充填品","name":"部品4","lot":"L-204","snp":10,"qty":10},{"type":"充填品","name":"部品5","lot":"L-205","snp":10,"qty":10},{"type":"充填品","name":"部品6","lot":"L-206","snp":10,"qty":10},{"type":"充填品","name":"部品7","lot":"L-207","snp":10,"qty":10},{"type":"充填品","name":"部品8","lot":"L-208","snp":10,"qty":10},{"type":"充填品","name":"部品9","lot":"L-209","snp":10,"qty":10}];
  const manualChecks = ["拡張様式になるか確認する","退避に残る品目と追記欄の順序・注釈を確認する"];
  ...
  console.info("入力完了: " + entered.length + "件 / " + totalP + "P（期待 107P）");
