// 基本入力・拡張様式 (basic-wide) — verified
// 現在の時間帯の入力と配置関連状態（配置不可設定を含む）をリセットします。
// 反対側の時間帯と品目マスタは変更しません。
// 専用オリジンまたは不要な入力の時間帯で実行してください。
(() => {
  const rows = [{"type":"充填品","name":"部品C","lot":"L-103","snp":10,"qty":245},{"type":"充填品","name":"部品A","lot":"L-101","snp":10,"qty":120},{"type":"充填品","name":"部品B","lot":"L-102","snp":10,"qty":70},{"type":"充填品","name":"部品D","lot":"L-104","snp":10,"qty":140},{"type":"充填品","name":"部品E","lot":"L-105","snp":10,"qty":60},{"type":"製品","name":"製品X","lot":"P-201","snp":10,"qty":60},{"type":"製品","name":"製品Y","lot":"P-202","snp":10,"qty":90},{"type":"製品","name":"製品Z","lot":"P-203","snp":10,"qty":110},{"type":"製品","name":"製品W","lot":"P-204","snp":10,"qty":80},{"type":"充填品","name":"部品1","lot":"L-201","snp":10,"qty":10},{"type":"充填品","name":"部品2","lot":"L-202","snp":10,"qty":10},{"type":"充填品","name":"部品3","lot":"L-203","snp":10,"qty":10},{"type":"充填品","name":"部品4","lot":"L-204","snp":10,"qty":10},{"type":"充填品","name":"部品5","lot":"L-205","snp":10,"qty":10}];
  const manualChecks = ["拡張様式が18列で表示される","追記欄に項目がない"];
