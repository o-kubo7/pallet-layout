...
test("列キャップに通路の印は付けない", () => {
  // 通路そのものの列は破線の枠、列の中の緊急用の通路マスは灰色のマスで分かる。
  // メインの列は幅44pxしかないので、列キャップには残量だけを出す
  assert.match(
    source,
